...
public class WikiLib {
    ...
    public ElementPairBuilder
            ...
            FAITH = new ElementPairBuilder(magicList).setLeft("Faith", "Light", 0xFFF2A8).setPosition(() -> x).setWidths(() -> width + 50, 5, ()-> width + 70).setRight("Rains piercing light upon your foes.", "","You don't have this spell.","Found via synthesis", 0x754e1a),
