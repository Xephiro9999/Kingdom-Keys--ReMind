...
public class StyleSpellweaver extends DriveForm {
    public StyleSpellweaver(ResourceLocation registeryName, int order, ResourceLocation skinRL, boolean hasKeychain, boolean baseGrowthAbilities) {
