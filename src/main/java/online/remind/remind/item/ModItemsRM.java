...
public class ModItemsRM{
    ...
    public static final Supplier<Item>
        ...
        osmoseraSpell = ITEMS.register("osmose1_spell", () -> new RMMagicSpellItem(new Item.Properties(), KingdomKeysReMind.MODID+":magic_osmose")),
        ...
        hastegaSpell = ITEMS.register("haste2_spell", () -> new RMMagicSpellItem(new Item.Properties(), KingdomKeysReMind.MODID+":magic_haste")),
        ...
        quickBlitz1Attack = ITEMS.register("quick_blitz1_attack", () -> new RMMagicSpellItem(new Item.Properties(), KingdomKeysReMind.MODID+":attack_quick_blitz")),
        slidingDash1Attack = ITEMS.register("sliding_dash1_attack", () -> new RMMagicSpellItem(new Item.Properties(), KingdomKeysReMind.MODID+":attack_sliding_dash")),
        fireSurge1Attack = ITEMS.register("fire_surge1_attack", () -> new RMMagicSpellItem(new Item.Properties(), KingdomKeysReMind.MODID+":attack_fire_surge")),
        thunderSurge1Attack = ITEMS.register("thunder_surge1_attack", () -> new RMMagicSpellItem(new Item.Properties(), KingdomKeysReMind.MODID+":attack_thunder_surge")),
        blizzardSurge1Attack = ITEMS.register("blizzard_surge1_attack", () -> new RMMagicSpellItem(new Item.Properties(), KingdomKeysReMind.MODID+":attack_blizzard_surge")),
        waterSurge1Attack = ITEMS.register("water_surge1_attack", () -> new RMMagicSpellItem(new Item.Properties(), KingdomKeysReMind.MODID+":attack_water_surge")),
        aeroSurge1Attack = ITEMS.register("aero_surge1_attack", () -> new RMMagicSpellItem(new Item.Properties(), KingdomKeysReMind.MODID+":attack_aero_surge")),
        lightSurge1Attack = ITEMS.register("light_surge1_attack", () -> new RMMagicSpellItem(new Item.Properties(), KingdomKeysReMind.MODID+":attack_light_surge")),
        darkSurge1Attack = ITEMS.register("dark_surge1_attack", () -> new RMMagicSpellItem(new Item.Properties(), KingdomKeysReMind.MODID+":attack_dark_surge")),
        zantetsuken1Attack = ITEMS.register("zantetsuken1_attack", () -> new RMMagicSpellItem(new Item.Properties(), KingdomKeysReMind.MODID+":attack_zantetsuken")),

        quickBlitz2Attack = ITEMS.register("quick_blitz2_attack", () -> new RMMagicSpellItem(new Item.Properties(), KingdomKeysReMind.MODID+":attack_quick_blitz")),
        slidingDash2Attack = ITEMS.register("sliding_dash2_attack", () -> new RMMagicSpellItem(new Item.Properties(), KingdomKeysReMind.MODID+":attack_sliding_dash")),
        fireSurge2Attack = ITEMS.register("fire_surge2_attack", () -> new RMMagicSpellItem(new Item.Properties(), KingdomKeysReMind.MODID+":attack_fire_surge")),
        thunderSurge2Attack = ITEMS.register("thunder_surge2_attack", () -> new RMMagicSpellItem(new Item.Properties(), KingdomKeysReMind.MODID+":attack_thunder_surge")),
        blizzardSurge2Attack = ITEMS.register("blizzard_surge2_attack", () -> new RMMagicSpellItem(new Item.Properties(), KingdomKeysReMind.MODID+":attack_blizzard_surge")),
        waterSurge2Attack = ITEMS.register("water_surge2_attack", () -> new RMMagicSpellItem(new Item.Properties(), KingdomKeysReMind.MODID+":attack_water_surge")),
        aeroSurge2Attack = ITEMS.register("aero_surge2_attack", () -> new RMMagicSpellItem(new Item.Properties(), KingdomKeysReMind.MODID+":attack_aero_surge")),
        lightSurge2Attack = ITEMS.register("light_surge2_attack", () -> new RMMagicSpellItem(new Item.Properties(), KingdomKeysReMind.MODID+":attack_light_surge")),
        darkSurge2Attack = ITEMS.register("dark_surge2_attack", () -> new RMMagicSpellItem(new Item.Properties(), KingdomKeysReMind.MODID+":attack_dark_surge")),
        zantetsuken2Attack = ITEMS.register("zantetsuken2_attack", () -> new RMMagicSpellItem(new Item.Properties(), KingdomKeysReMind.MODID+":attack_zantetsuken")),
