    ...
    public void equipAbility(AbilityEvent.Equip event) {
        if (KingdomKeysReMind.efmLoaded) {
            ...
            if (event.getAbility().equals(ModAbilitiesRM.RENEWAL_BLOCK.get())) {
                if (playerData.isAbilityEquipped(StringsRM.focusBlock) || playerData.isAbilityEquipped(StringsRM.stopBlock) || playerData.isAbilityEquipped(StringsRM.royalGuard) || playerData.isAbilityEquipped(StringsRM.poisonBlock) || playerData.isAbilityEquipped(StringsRM.blockReplenisher)) {
                    ...
                    playerData.unequipAbility(StringsRM.blockReplenisher, 0);
                }
            }

            if (event.getAbility().equals(ModAbilitiesRM.FOCUS_BLOCK.get())) {
                if (playerData.isAbilityEquipped(StringsRM.renewalBlock) || playerData.isAbilityEquipped(StringsRM.stopBlock) || playerData.isAbilityEquipped(StringsRM.royalGuard) || playerData.isAbilityEquipped(StringsRM.poisonBlock) || playerData.isAbilityEquipped(StringsRM.blockReplenisher)) {
            ...
            if (event.getAbility().equals(ModAbilitiesRM.STOP_BLOCK.get())) {
                if (playerData.isAbilityEquipped(StringsRM.renewalBlock) || playerData.isAbilityEquipped(StringsRM.focusBlock) || playerData.isAbilityEquipped(StringsRM.royalGuard) || playerData.isAbilityEquipped(StringsRM.poisonBlock) || playerData.isAbilityEquipped(StringsRM.blockReplenisher)) {
                    playerData.unequipAbility(StringsRM.renewalBlock, 0);
                    playerData.unequipAbility(StringsRM.focusBlock, 0);
                    playerData.unequipAbility(StringsRM.royalGuard, 0);
                    playerData.unequipAbility(StringsRM.poisonBlock, 0);
            ...
            if (event.getAbility().equals(ModAbilitiesRM.ROYAL_GUARD.get())) {
                if (playerData.isAbilityEquipped(StringsRM.renewalBlock) || playerData.isAbilityEquipped(StringsRM.stopBlock) || playerData.isAbilityEquipped(StringsRM.focusBlock) || playerData.isAbilityEquipped(StringsRM.poisonBlock) || playerData.isAbilityEquipped(StringsRM.blockReplenisher)) {
                    playerData.unequipAbility(StringsRM.renewalBlock, 0);
                    playerData.unequipAbility(StringsRM.stopBlock, 0);
                    playerData.unequipAbility(StringsRM.focusBlock, 0);
                    playerData.unequipAbility(StringsRM.poisonBlock, 0);
            ...
            if (event.getAbility().equals(ModAbilitiesRM.POISON_BLOCK.get())) {
                if (playerData.isAbilityEquipped(StringsRM.renewalBlock) || playerData.isAbilityEquipped(StringsRM.stopBlock) || playerData.isAbilityEquipped(StringsRM.focusBlock) || playerData.isAbilityEquipped(StringsRM.royalGuard) || playerData.isAbilityEquipped(StringsRM.blockReplenisher)) {
                    playerData.unequipAbility(StringsRM.renewalBlock, 0);
                    playerData.unequipAbility(StringsRM.stopBlock, 0);
                    playerData.unequipAbility(StringsRM.focusBlock, 0);
                    playerData.unequipAbility(StringsRM.royalGuard, 0);
            ...
            if (event.getAbility().equals(ModAbilitiesRM.BLOCK_REPLENISHER.get())) {
                if (playerData.isAbilityEquipped(StringsRM.renewalBlock) || playerData.isAbilityEquipped(StringsRM.stopBlock) || playerData.isAbilityEquipped(StringsRM.focusBlock) || playerData.isAbilityEquipped(StringsRM.royalGuard) || playerData.isAbilityEquipped(StringsRM.poisonBlock)) {
                    playerData.unequipAbility(StringsRM.renewalBlock, 0);
                    playerData.unequipAbility(StringsRM.stopBlock, 0);
                    playerData.unequipAbility(StringsRM.focusBlock, 0);
                    playerData.unequipAbility(StringsRM.royalGuard, 0);
