...
public class EpicRMWeapons {
    public static final Function<Item, WeaponCapability.Builder> XEPHIRO = item -> {
        WeaponCapability.Builder builder = WeaponCapability.builder()
                ...
                .newStyleCombo(CapabilityItem.Styles.MOUNT, Animations.SWORD_MOUNT_ATTACK).innateSkill(CapabilityItem.Styles.ONE_HAND, itemstack -> Skill.skillOrNull(EpicFightSkills.EVISCERATE)).innateSkill(CapabilityItem.Styles.TWO_HAND, itemstack -> Skill.skillOrNull(EpicFightSkills.BLADE_RUSH))
    ...
    public static void register(WeaponCapabilityPresetRegistryEvent event) {
        event.getTypeEntry().put(ResourceLocation.fromNamespaceAndPath(KingdomKeysReMind.MODID,EpicRMWeaponEnum.XEPHIRO.toString().toLowerCase()), (Function<Item, ? extends CapabilityItem.Builder<?>>) XEPHIRO);
    }
