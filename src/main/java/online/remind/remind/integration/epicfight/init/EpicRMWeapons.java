        ...
        WeaponCapability.builder()
                .category(CapabilityItem.WeaponCategories.SWORD).styleProvider(playerpatch ->
                        switch (PlayerData.get((Player) playerpatch.getOriginal()).getActiveDriveForm()) {
                            ...
                            default ->
                                playerpatch.getHoldingItemCapability(InteractionHand.OFF_HAND).getWeaponCategory() == EpicKKWeapons.KEYBLADE ? CapabilityItem.Styles.TWO_HAND : CapabilityItem.Styles.ONE_HAND;
                        })
