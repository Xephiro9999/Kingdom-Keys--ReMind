...
public class ModAbilitiesRM extends ModAbilities{
    ...
    public static final Supplier<Ability>
        ...
        CONFUSION_BLOCK = ABILITIES.register(StringsRM.ABMA_Prefix+"confusion_block", () -> new Ability(ResourceLocation.parse(StringsRM.confusionBlock), 0, Ability.AbilityType.ACTION, order++)),
